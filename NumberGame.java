...
public class NumberGame {
    ...
    private static int startGame(int n) {
        int i;
        System.out.println(
                "GUIDELINES:  GUESS THE NUMBER (1-100) IN MAX 10 ATTEMPTS AND GET YOU SCORE ACCORDING TO " + "IT");
    ...
    // main function here multiple rounds can be played by the user and the game is
    // started
